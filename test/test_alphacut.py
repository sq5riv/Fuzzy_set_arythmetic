...
def test_alpha_cut_border_prep_corect(left_borders, right_borders) -> None:
...
def test_alpha_cut_border_prep_incorect(left_borders: float, right_borders: float) -> None:
